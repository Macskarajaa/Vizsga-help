...
export default function FlowersByCateg() {
    ...
    const getFlowers = async () => {
        try {
            const resJSON = await fetch(`http://localhost:3333/api/flowersbycateg/${id}`);
            ...
            <div className="flowerContainer">
                {
                    flowers.length ?
                    <>
                        <p style={{ fontWeight: 'bold', fontSize: '1.2rem' }}>{flowers[0]?.kategNev} kategória</p>
